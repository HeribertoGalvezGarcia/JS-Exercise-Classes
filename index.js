...
class Instructor extends Lambdasian {
  ...
  gradeStudent(student) {
    student.grade += Math.floor((Math.random() - 0.5) * 11); // Raise or lower a grade from between -5 to +5
  }
}
...
class GradedStudent extends Student {
  constructor(information) {
    super(information);
    this.grade = Math.floor(Math.random * 101); // Random number between 1 and 100
  }
